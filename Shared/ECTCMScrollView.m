...
@implementation ECTCMScrollView{
...
-(void)handlePanFrom:(UIPanGestureRecognizer*)recognizer{
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        view.center = [self convertPoint:view.center toView:self.superview.superview];
        [self.superview.superview insertSubview:view aboveSubview:self];//addSubview:view];
        [UIView animateWithDuration:0.2 animations:^{
            view.transform = CGAffineTransformMakeScale(1.2, 1.2);
            view.center = [recognizer locationInView:view.superview.superview];
            //view.alpha = 0.7;
